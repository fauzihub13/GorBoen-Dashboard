                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <?php
                                ...
                                <div class="card-body">
                                    <form method="POST"
                                        action="{{ route('kebun.update', $value->_id) }}"
                                        class="needs-validation"
                                        novalidate="">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">ID Pemilik</label>
                                            <div class="col-sm-12 col-md-7">
                                                <input type="text" name="id"
                                                    class="form-control" value="{{ $value->_id }}" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                ...
                                                data-height="150" /required> {{ $value->detail_wisata }} </textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
