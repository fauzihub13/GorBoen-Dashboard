...
class NewsController extends Controller
{
    ...
    public function index(){
        ...
        $dataNews = $this->readAllNews();

        // $dataNews->pagination(10);
        return view("pages.news.index", compact("dataNews"));
        // var_dump($dataNews);
    ...
    public function store(Request $request){
        ...
        if ($data->success === true) {
            ...
            return redirect("/news")->with('error', $data->message);
    ...
    public function edit($newsId){
        ...
        $dataNews = $this->readAllNews("?id=" . $newsId);

        return view("pages.news.edit", compact("dataNews"));
